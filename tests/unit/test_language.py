...
class TestLanguageDetector(unittest.TestCase):
    ...
    def test_module_level_functions(self):
        ...
        with patch('api.rag_pipeline.language.detect_language') as mock_detect_language, \
            patch('api.rag_pipeline.language.detect_language_with_details') as mock_detect_details, \
            patch('api.rag_pipeline.language.translate_text') as mock_translate_text:
            ...
            translated_with_source = language_module.translate_text("Hola mundo", target_lang="en", source_lang="es")
