...
def vector_search(session, embedding, limit, user_email, threshold: float = 0.3):
    """
...
def query_ollama_with_hybrid_search_multilingual(session, question, embedding_model, 
    ...
    try:
        ...
        context_chunks, reranked_chunks = hybrid_search(session, english_question, query_embedding, vector_k, bm25_k, user_email)
