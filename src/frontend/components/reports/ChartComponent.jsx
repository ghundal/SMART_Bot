  ...
  useEffect(() => {
    ...
    if (chartRef.current) {
      ...
      data.forEach((item, index) => {
        ...
        barLabel.textContent = typeof item[xKey] === 'string' && item[xKey].includes('T') 
  ...
  useEffect(() => {
    ...
    if (chartRef.current) {
      ...
      const points = data.map((item, index) => {
        ...
        title.textContent = `${typeof item[xKey] === 'string' && item[xKey].includes('T') 
      ...
      data.forEach((item, index) => {
        ...
        label.textContent = typeof item[xKey] === 'string' && item[xKey].includes('T') 
          ? new Date(item[xKey]).toLocaleDateString(undefined, { month: 'short', day: 'numeric' })
          : item[xKey];
